...
xrandr --output eDP1 --off --output DP2 --off --output DP1 --primary --mode 0x542 --pos 0x0 --rotate normal --output DP3 --off --output HDMI1 --off --output HDMI2 --off --output HDMI3 --off --output VIRTUAL1 --off
